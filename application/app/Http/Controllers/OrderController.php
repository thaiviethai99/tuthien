...
class OrderController extends Controller
{
    ...
    public function allOrders()
    {
        ...
        $orders = Orders::where('is_delete',0)->get();
    ...
    public function viewOrder($id)
    {
        ...
        if ($order) {
            $client = Client::where('status', 'Active')->find($order->cl_id);
            return view('admin.view-order', compact('client', 'order'));
        } else {
            return redirect('invoices/all')->with([
                'message' => language_data('Invoice not found'),
                'message_important' => true
    ...
    public function deleteOrder($id)
    {
        ...
        if ($order) {
            ...
            return redirect('orders/all')->with([
