...
class DashboardController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $sms_count=SMSInbox::count();
        $sms_success=SMSInbox::where('status','like','%Success%')->count();
        ...
        $day_10_count_inbound=SMSInbox::where('send_by','receiver')->whereDay('created_at',get_mysql_date($day_10))->count();
        $day_10_count_outbound=SMSInbox::where('send_by','sender')->whereDay('created_at',get_mysql_date($day_10))->count();

        $day_9_count_inbound=SMSInbox::where('send_by','receiver')->whereDay('created_at',get_mysql_date($day_9))->count();
        $day_9_count_outbound=SMSInbox::where('send_by','sender')->whereDay('created_at',get_mysql_date($day_9))->count();

        $day_8_count_inbound=SMSInbox::where('send_by','receiver')->whereDay('created_at',get_mysql_date($day_8))->count();
        $day_8_count_outbound=SMSInbox::where('send_by','sender')->whereDay('created_at',get_mysql_date($day_8))->count();

        $day_7_count_inbound=SMSInbox::where('send_by','receiver')->whereDay('created_at',get_mysql_date($day_7))->count();
        $day_7_count_outbound=SMSInbox::where('send_by','sender')->whereDay('created_at',get_mysql_date($day_7))->count();

        $day_6_count_inbound=SMSInbox::where('send_by','receiver')->whereDay('created_at',get_mysql_date($day_6))->count();
        $day_6_count_outbound=SMSInbox::where('send_by','sender')->whereDay('created_at',get_mysql_date($day_6))->count();

        $day_5_count_inbound=SMSInbox::where('send_by','receiver')->whereDay('created_at',get_mysql_date($day_5))->count();
        $day_5_count_outbound=SMSInbox::where('send_by','sender')->whereDay('created_at',get_mysql_date($day_5))->count();

        $day_4_count_inbound=SMSInbox::where('send_by','receiver')->whereDay('created_at',get_mysql_date($day_4))->count();
        $day_4_count_outbound=SMSInbox::where('send_by','sender')->whereDay('created_at',get_mysql_date($day_4))->count();

        $day_3_count_inbound=SMSInbox::where('send_by','receiver')->whereDay('created_at',get_mysql_date($day_3))->count();
        $day_3_count_outbound=SMSInbox::where('send_by','sender')->whereDay('created_at',get_mysql_date($day_3))->count();

        $day_2_count_inbound=SMSInbox::where('send_by','receiver')->whereDay('created_at',get_mysql_date($day_2))->count();
        $day_2_count_outbound=SMSInbox::where('send_by','sender')->whereDay('created_at',get_mysql_date($day_2))->count();

        $day_1_count_inbound=SMSInbox::where('send_by','receiver')->whereDay('created_at',get_mysql_date($day_1))->count();
        $day_1_count_outbound=SMSInbox::where('send_by','sender')->whereDay('created_at',get_mysql_date($day_1))->count();
