    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
          ...
          <div class="list-items-wrap">
             <h1 style="margin-left: 20px;color: #113067;font-size:28px;padding-top: 16px">News</h1>
             @foreach($news as $item)
          <div class="list-item-dem">
              <div class="row">
                <div class="col-md-2 col-xs-3">  
                  <a href="{{url('news-events/news-detail/'.$item->id.'/'.vn_to_str($item->title_en))}}" class="thumbnail">
