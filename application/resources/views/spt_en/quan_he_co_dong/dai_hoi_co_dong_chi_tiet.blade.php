        ...
        <header class="page-heading clearfix">
            <div class="breadcrumbs pull-left">
                <ul class="breadcrumbs-list">
                    ...
                    <li><a href="#">Annual General Meeting</a><i class="fa fa-angle-right"></i></li>
					           <li><a href="#">Annual General Meeting {{$year}}</a></li>
        ...
        <div class="page-content">
            <div class="row page-row">
                <div class="faq-wrapper col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="article-left"><div class="article-item-name"><h1>Annual General Meeting {{$year}}
            ...
            <?php 
                        ...
                        <div id="article-item2" class="article-list-item mtwo col-sm-4">
                           <a href="{{url('investor-relation/annual-general-meeting-detail/'.$item->id.'/annual-general-meeting-'.$year)}}">
                              <div class="article-list-item-content @if(Request::path()=='investor-relation/annual-general-meeting-detail/'.$item->id.'/annual-general-meeting-'.$year) article-select @endif">
