        ...
        <header class="page-heading clearfix">
            <div class="breadcrumbs pull-left">
                <ul class="breadcrumbs-list">
                    ...
                    <li class="">Construction & Trading Telecommunication Equipments
</li>
                </ul>
            </div><!--//breadcrumbs-->
        </header>
        ...
        <div class="page-content">
            <div class="row page-row">
                <div class="faq-wrapper col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="article-left"><div class="article-item-name"><h1>Construction & Trading Telecommunication Equipments
</h1></div>
                ...
                <aside class="page-sidebar col-sm-12 col-md-3" style="padding-left:0px">
                        <div id="article-item0" class="article-list-item mtwo col-sm-4">
                           <a href="{{url('services-quality/other-services/construction-trading-telecommunication-equipments')}}">
                              <div class="article-list-item-content article-select">
                                 <div class="article-list-name">Construction & Trading Telecommunication Equipments
</div>
                              </div>
                           </a>
                        </div>
                        <div id="article-item1" class="article-list-item mone col-sm-4">
                           <a href="{{url('services-quality/other-services/content-provision')}}">
                              <div class="article-list-item-content ">
                                 <div class="article-list-name">Content provision</div>
                              </div>
                           </a>
                        </div>
