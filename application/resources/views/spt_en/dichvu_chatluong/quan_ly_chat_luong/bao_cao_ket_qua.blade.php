    ...
    <div class="page-wrapper">
        ...
        <header class="page-heading clearfix">
            <div class="breadcrumbs pull-left">
                <ul class="breadcrumbs-list">
                    ...
                    <li class="">The results of the self-test periodic quality of telecommunications services and results of self-test quality indicators for each service</li>
                </ul>
            </div><!--//breadcrumbs-->
        </header>
        </div>
        <div class="page-content">
          ...
          <div class="list-items-wrap">
             <h1 style="margin-left: 20px;color: #113067;font-size:28px;padding-top: 16px">The results of the self-test periodic quality of telecommunications services and results of self-test quality indicators for each service
            </h1>
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                  <div class="list-item-dem-header">
                    <a href="{{url('services-quality/service-standards/the-results-of-the-self-test-periodic-quality-of-telecommunications-services-and-results-of-self-test-quality-indicators-for-each-service-detail/'.$item->id.'/'.vn_to_str($item->title_en))}}">  
