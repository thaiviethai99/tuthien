        ...
        <header class="page-heading clearfix">
            <div class="breadcrumbs pull-left">
                <ul class="breadcrumbs-list">
                    ...
                    <li class="">Announcement of the quality of telecommunications services
</li>
                </ul>
            </div><!--//breadcrumbs-->
        </header>
        ...
        <div class="page-content">
            <div class="row page-row">
                <div class="faq-wrapper col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="article-left"><div class="article-item-name"><h1>Announcement of the quality of telecommunications services
</h1></div>
