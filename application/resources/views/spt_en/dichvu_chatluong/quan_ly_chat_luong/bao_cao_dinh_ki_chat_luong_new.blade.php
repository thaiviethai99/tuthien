    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
          ...
          <div class="list-items-wrap">
             <h1 style="margin-left: 20px;color: #113067;font-size:28px;padding-top: 16px">Reporting periodically the quality of telecommunications services
            </h1>
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                  <div class="list-item-dem-header">
                    <a href="{{url('services-quality/service-standards/reporting-periodically-the-quality-of-telecommunications-services-detail/'.$item->id.'/'.vn_to_str($item->title))}}">  
