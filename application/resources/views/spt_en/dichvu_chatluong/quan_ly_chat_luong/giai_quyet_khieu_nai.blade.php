        ...
        <header class="page-heading clearfix">
            <div class="breadcrumbs pull-left">
                <ul class="breadcrumbs-list">
                    ...
                    <li class="">Process of receiving and resolving customer complaints</li>
                </ul>
            </div><!--//breadcrumbs-->
        </header>
        </div>
        <div class="page-content">
            <div class="row page-row">
                <div class="faq-wrapper col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="article-left"><div class="article-item-name"><h1>Process of receiving and resolving customer complaints</h1></div>
