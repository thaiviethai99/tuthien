...
@section('content')
        ...
        <header class="page-heading clearfix">
            <div class="breadcrumbs pull-left">
                 <ul class="breadcrumbs-list">
                    ...
                    <li class="">Report the test service quality and the result of the quality checksum for the quality service</li>
                </ul>
            </div><!--//breadcrumbs-->
        </header>
        </div>
   ...
   <div class="article-item-name">
      <h1>Report the test service quality and the result of the quality checksum for the quality service</h1>
   </div>
