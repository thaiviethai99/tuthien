        ...
        <header class="page-heading clearfix">
            <div class="breadcrumbs pull-left">
                <ul class="breadcrumbs-list">
                    ...
                    <li class=""><a href="{{url('services-quality/service-standards/sample-contract-for-service-delivery')}}">Sample contract for service delivery</a><i class="fa fa-angle-right"></i>
</li>
