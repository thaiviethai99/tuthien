            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
						...
						<li role="presentation"><a href="#thongTinThueBao" aria-controls="thongTinThueBao" role="tab" data-toggle="tab">Thông tin thuê bao</a></li>
						<li role="presentation"><a href="#thongtinThanhToan" aria-controls="thongtinThanhToan" role="tab" data-toggle="tab">Thông tin thanh toán</a></li>
                    </ul>
                    ...
                    <div class="tab-content panel p-20">
                            ...
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                @foreach($tickets as $in)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a href="{{url('user/tickets/view-ticket/'.$in->id)}}" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> {{language_data('View')}}</a>
                                        </td>
                                    </tr>
                                @endforeach
                                ...
                                @foreach($invoices as $in)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('user/invoices/edit/'.$in->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> {{language_data('Edit')}}</a>
                                        </td>
                                    </tr>
                                @endforeach
						...
						<div role="tabpanel" class="tab-pane" id="thongTinThueBao">
                           <table class="table table-hover table-ultra-responsive" >
							  <tr><td>Họ tên thuê bao : </td><td id="hotenThueBao">{{$dataArray->ten_tb}}</td></tr>
							  <tr><td>Địa chỉ thuê bao : </td><td id="diaChiThueBao">{{$dataArray->diachi_tb}}</td></tr>
							</table>
						</div>
						<div role="tabpanel" class="tab-pane" id="thongtinThanhToan">
                            <table class="table data-table table-hover table-ultra-responsive">
                                <thead>
                                <tr>
                                    <th style="width: 5%;">#</th>
                            ...
                            <div class="input-group input-group-file">
                                        <span class="input-group-btn">
                                            <span class="btn btn-primary btn-file">
                                                {{language_data('Browse')}} <input type="file" class="form-control" name="client_image">
                                            </span>
                                        </span>
