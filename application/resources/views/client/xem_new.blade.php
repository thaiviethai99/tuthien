                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" action="{{ url('client/editNewApproval')}}" method="POST" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10 view">
                                  <div class="checkbox">
                                    <label><input type="checkbox" name="is_approval" disabled="disabled" id="is_approval" value="1" @if($newDetail->is_approval==1) checked @endif></label>
                                  </div>
                                </div>
                              </div>
                              <div class="form-group">
