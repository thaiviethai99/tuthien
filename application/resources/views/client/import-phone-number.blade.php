                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <a href="{{url('user/sms/download-sample-sms-file')}}" class="btn btn-complete"><i class="fa fa-download"></i> {{language_data('Download Sample File')}}</a>
                                </div>
                            </div>

                            <form class="" role="form" method="post" action="{{url('user/sms/post-import-phone-number')}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover table-ultra-responsive">
                                <thead>
                                <tr>
                                    <th style="width: 25%;">{{language_data('SL')}}#</th>
                                    <th style="width: 50%;">{{language_data('Group Name')}}</th>
