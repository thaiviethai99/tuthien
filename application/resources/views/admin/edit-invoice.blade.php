                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <table class="table table-hover" id="invoice_items">
                                            ...
                                            <tr class="info">
                                                <td><input type="text" class="form-control item_name" name="desc[]" value="{{$it->item}}"></td>
                                                <td><input type="text" class="form-control item_price" name="amount[]" value="{{$it->price}}"></td>
                                                <td><input type="text" class="form-control qty" value="{{$it->qty}}" name="qty[]"></td>
                                                <td><input type="text" class="form-control tax" name="taxed[]" value="{{$it->tax}}"> </td>
                                                <td><input type="text" class="form-control discount" name="discount[]" value="{{$it->discount}}"> </td>
                                                <td class="ltotal"><input type="text" class="form-control lvtotal" readonly="" name="ltotal[]" value="{{$it->total}}"></td>
                                            </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
                                        ...
                                        <div class="row bottom-inv-con">
                                            <div class="col-md-6">
                                                <button type="button" class="btn btn-success" id="blank-add"><i class="fa fa-plus"></i> {{language_data('Add Item')}}</button>
                                                <button type="button" class="btn btn-danger" id="item-remove"><i class="fa fa-minus-circle"></i> {{language_data('Delete')}}</button>
                                            </div>
                                            <div class="col-md-6">
