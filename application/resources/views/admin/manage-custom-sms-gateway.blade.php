                        ...
                        <div class="panel-body">
                            ...
                            <form role="form" method="post" action="{{url('sms/post-custom-sms-gateway')}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <table class="table table-hover" id="gateway_items">
                                            <thead>
                                            <tr>
                                                <th width="20%"></th>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" required name="username_param" class="form-control" value="{{$gateway_info->username_param}}"></td>
                                                <td><input type="text" autocomplete="off" required name="username_value" class="form-control"  value="{{$gateway_info->username_value}}"></td>
                                                <td></td>
                                            </tr>

                                            <tr class="item-row info">
                                                <td>{{language_data('Password')}}</td>
                                                <td><input type="text" autocomplete="off" name="password_param" class="form-control"  value="{{$gateway_info->password_param}}"></td>
                                                <td><input type="text" autocomplete="off" name="password_value" class="form-control"  value="{{$gateway_info->password_value}}"></td>
                                                <td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" name="action_param" class="form-control"  value="{{$gateway_info->action_param}}"></td>
                                                <td><input type="text" autocomplete="off" name="action_value" class="form-control"  value="{{$gateway_info->action_value}}"></td>
                                                <td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" name="source_param" class="form-control"  value="{{$gateway_info->source_param}}"></td>
                                                <td><input type="text" autocomplete="off" name="source_value" class="form-control"  value="{{$gateway_info->source_value}}"></td>
                                                <td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" required name="destination_param" class="form-control"  value="{{$gateway_info->destination_param}}"></td>
                                                <td></td>
                                                <td></td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" required name="message_param" class="form-control"  value="{{$gateway_info->message_param}}"></td>
                                                <td></td>
                                                <td></td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" name="unicode_param" class="form-control"  value="{{$gateway_info->unicode_param}}"></td>
                                                <td><input type="text" autocomplete="off" name="unicode_value" class="form-control"  value="{{$gateway_info->unicode_value}}"></td>
                                                <td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" name="route_param" class="form-control"  value="{{$gateway_info->route_param}}"></td>
                                                <td><input route="text" autocomplete="off" name="route_value" class="form-control"  value="{{$gateway_info->route_value}}"></td>
                                                <td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" name="language_param" class="form-control"  value="{{$gateway_info->language_param}}"></td>
                                                <td><input type="text" autocomplete="off" name="language_value" class="form-control"  value="{{$gateway_info->language_value}}"></td>
                                                <td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" name="custom_one_param" class="form-control"  value="{{$gateway_info->custom_one_param}}"></td>
                                                <td><input type="text" autocomplete="off" name="custom_one_value" class="form-control"  value="{{$gateway_info->custom_one_value}}"></td>
                                                <td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" name="custom_two_param" class="form-control"  value="{{$gateway_info->custom_two_param}}"></td>
                                                <td><input type="text" autocomplete="off" name="custom_two_value" class="form-control"  value="{{$gateway_info->custom_two_value}}"></td>
                                                <td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" name="custom_three_param" class="form-control"  value="{{$gateway_info->custom_three_param}}"></td>
                                                <td><input type="text" autocomplete="off" name="custom_three_value" class="form-control"  value="{{$gateway_info->custom_three_value}}"></td>
                                                <td>
...
@section('script')
    ...
    {!! Html::script("assets/js/custom-sms-gateway-management.js")!!}
@endsection