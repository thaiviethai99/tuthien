                            ...
                            <div class="clearfix">
                                ...
                                <div class="pull-left">
                                    ...
                                    <ul class="info-list">
                                        ...
                                        <li>
                                            <span class="info-list-title">{{language_data('SMS Gateway')}}</span><span class="info-list-des">{{$client->get_sms_gateway->name}}</span>
                                        </li>
                                    </ul>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker form-control" name="sms_gateway"  data-live-search="true">
                                                @foreach($sms_gateways as $sg)
                                                    <option value="{{$sg->id}}" @if($client->sms_gateway==$sg->id) selected @endif>{{$sg->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
