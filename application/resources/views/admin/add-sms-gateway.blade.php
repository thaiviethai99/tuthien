                                    ...
                                    <div class="col-lg-8">
                                        <table class="table table-hover" id="gateway_items">
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" required name="username_param" class="form-control"></td>
                                                <td><input type="text" autocomplete="off" required name="username_value" class="form-control"></td>
                                                <td></td>
                                            </tr>

                                            <tr class="item-row info">
                                                <td>{{language_data('Password')}}</td>
                                                <td><input type="text" autocomplete="off" name="password_param" class="form-control"></td>
                                                <td><input type="text" autocomplete="off" name="password_value" class="form-control"></td>
                                                <td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" name="action_param" class="form-control"></td>
                                                <td><input type="text" autocomplete="off" name="action_value" class="form-control"></td>
                                                <td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" name="source_param" class="form-control"></td>
                                                <td><input type="text" autocomplete="off" name="source_value" class="form-control"></td>
                                                <td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" required name="destination_param" class="form-control"></td>
                                                <td></td>
                                                <td></td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" required name="message_param" class="form-control"></td>
                                                <td></td>
                                                <td></td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" name="unicode_param" class="form-control"></td>
                                                <td><input type="text" autocomplete="off" name="unicode_value" class="form-control"></td>
                                                <td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" name="route_param" class="form-control"></td>
                                                <td><input route="text" autocomplete="off" name="route_value" class="form-control"></td>
                                                <td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" name="language_param" class="form-control"></td>
                                                <td><input type="text" autocomplete="off" name="language_value" class="form-control"></td>
                                                <td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" name="custom_one_param" class="form-control"></td>
                                                <td><input type="text" autocomplete="off" name="custom_one_value" class="form-control"></td>
                                                <td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" name="custom_two_param" class="form-control"></td>
                                                <td><input type="text" autocomplete="off" name="custom_two_value" class="form-control"></td>
                                                <td>
                                            ...
                                            <tr class="item-row info">
                                                ...
                                                <td><input type="text" autocomplete="off" name="custom_three_param" class="form-control"></td>
                                                <td><input type="text" autocomplete="off" name="custom_three_value" class="form-control"></td>
                                                <td>
