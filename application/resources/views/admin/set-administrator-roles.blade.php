                            ...
                            <form class="" role="form" action="{{url('administrators/update-admin-set-roles')}}" method="post">
                                ...
                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        ...
                                        <span class="co-check-ui"></span>
                                        <label>{{language_data('Send SMS')}}</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        ...
                                        <span class="co-check-ui"></span>
                                        <label>{{language_data('Import Phone Number')}}</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        ...
                                        <span class="co-check-ui"></span>
                                        <label>{{language_data('SMS By Phone Number')}}</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        ...
                                        <span class="co-check-ui"></span>
                                        <label>{{language_data('Bulk Birthday SMS')}}</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        ...
                                        <span class="co-check-ui"></span>
                                        <label>{{language_data('Bulk SMS Remainder')}}</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="coder-checkbox">
