                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <a href="{{url('sms/download-sample-remainder-sms-file')}}" class="btn btn-complete"><i class="fa fa-download"></i> {{language_data('Download Sample File')}}</a>
                                </div>
                            </div>

                            <form class="" role="form" method="post" action="{{url('sms/post-bulk-remainder-sms')}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
