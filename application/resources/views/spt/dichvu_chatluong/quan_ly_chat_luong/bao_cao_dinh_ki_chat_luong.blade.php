        ...
        <header class="page-heading clearfix">
            <div class="breadcrumbs pull-left">
                <ul class="breadcrumbs-list">
                    ...
                    <li class="">Báo cáo định kỳ chất lượng dịch vụ viễn thông</li>
                </ul>
            </div><!--//breadcrumbs-->
        </header>
        </div>
        <div class="page-content">
            <div class="row page-row">
                <div class="faq-wrapper col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="article-left"><div class="article-item-name"><h1>Báo cáo định kỳ chất lượng dịch vụ viễn thông
</h1></div>
              ...
              <?php }?>
                ...
                <aside class="page-sidebar col-sm-12 col-md-3" style="padding-left:0px">
                        <div id="article-item0" class="article-list-item mtwo col-sm-4">
                           <a href="{{url('dich-vu-chat-luong/quan-ly-chat-luong-dich-vu/bao-cao-ket-qua-tu-kiem-tra-dinh-ky-chat-luong-dich-vu-va-ket-qua-tu-do-kiem-chi-tieu-chat-luong-cho-tung-dich-vu')}}">
                              <div class="article-list-item-content">
                                 <div class="article-list-name">Báo cáo kết quả tự kiểm tra định kỳ chất lượng dịch vụ và Kết quả tự đo kiểm chỉ tiêu chất lượng cho từng dịch vụ</div>
                              </div>
                           </a>
                        </div>
						...
						<div id="article-item4" class="article-list-item mtwo col-sm-4">
                           <a href="{{url('dich-vu-chat-luong/quan-ly-chat-luong-dich-vu/ban-cong-bo-chat-luong-dich-vu-spt-dang-cung-cap')}}">
                              <div class="article-list-item-content">
                                 <div class="article-list-name">Bản công bố chất lượng dịch vụ SPT đang cung cấp</div>
                              </div>
                           </a>
                        </div>
						<div id="article-item4" class="article-list-item mtwo col-sm-4">
                           <a href="{{url('dich-vu-chat-luong/quan-ly-chat-luong-dich-vu/cac-quy-chuan-tieu-chuan-ky-thuat')}}">
                              <div class="article-list-item-content">
                                 <div class="article-list-name">Các quy chuẩn - tiêu chuẩn kỹ thuật</div>
                              </div>
                           </a>
                        </div>
                        <div id="article-item4" class="article-list-item mtwo col-sm-4">
