    ...
    <div class="page-wrapper">
            ...
            <div class="breadcrumbs pull-left">
                <ul class="breadcrumbs-list">
                    <li><a href="{{url('/')}}">Trang chủ</a><i class="fa fa-angle-right"></i></li>
                     ...
                     <li>Hợp đồng mẫu cung cấp dịch vụ
</li>
                </ul>
            </div><!--//breadcrumbs-->
        </header>
        ...
        <div class="page-content">
          ...
          <div class="list-items-wrap">
             <h1 style="margin-left: 20px;color: #113067;font-size:28px;padding-top: 16px">Hợp đồng mẫu cung cấp dịch vụ
            </h1>
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                  <div class="list-item-dem-header">
                    <a href="{{url('dich-vu-chat-luong/quan-ly-chat-luong-dich-vu/hop-dong-mau-cung-cap-dich-vu-chi-tiet/'.$item->id.'/'.vn_to_str($item->title))}}">  
