            ...
            <div class="breadcrumbs pull-left">
                <ul class="breadcrumbs-list">
                    <li><a href="{{url('/')}}">Trang chủ</a><i class="fa fa-angle-right"></i></li>
                     ...
                     <li><a href="{{url('dich-vu-chat-luong/quan-ly-chat-luong-dich-vu/bao-cao-dinh-ky-chat-luong-dich-vu-vien-thong')}}">Báo cáo định kỳ chất lượng dịch vụ viễn thông</a><i class="fa fa-angle-right"></i></li>
                    <li class="">{{$new->title}}
