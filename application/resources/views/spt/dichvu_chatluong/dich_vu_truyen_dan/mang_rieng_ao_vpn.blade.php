            ...
            <div class="breadcrumbs pull-left">
                <ul class="breadcrumbs-list">
                    <li><a href="{{url('/')}}">Trang chủ</a><i class="fa fa-angle-right"></i></li>
                     ...
                     <li><a href="{{url('dich-vu-chat-luong/dich-vu-truyen-dan')}}">Dịch vụ truyền dẫn</a><i class="fa fa-angle-right"></i></li>
                    <li class="">Mạng riêng ảo (VPN - Virtual Private Network)
</li>
                </ul>
            </div><!--//breadcrumbs-->
        </header>
        ...
        <div class="page-content">
            <div class="row page-row">
                 <div class="faq-wrapper col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="article-left"><div class="article-item-name"><h1>Mạng riêng ảo (VPN - Virtual Private Network)
</h1></div>
