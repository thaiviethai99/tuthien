            ...
            <div class="breadcrumbs pull-left">
                <ul class="breadcrumbs-list">
                    <li><a href="{{url('/')}}">Trang chủ</a><i class="fa fa-angle-right"></i></li>
                     ...
                     <li><a href="{{url('dich-vu-chat-luong/swifi')}}">S-wifi</a><i class="fa fa-angle-right"></i></li>
                    <li class="">Dịch vụ S-wifi
        ...
        <div class="page-content">
            <div class="row page-row">
                <div class="faq-wrapper col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="article-left"><div class="article-item-name"><h1>Dịch vụ S-wifi
                        ...
                        <div id="article-item0" class="article-list-item mtwo col-sm-4">
                           <a href="{{url('dich-vu-chat-luong/swifi')}}">
                              <div class="article-list-item-content article-select">
                                 <div class="article-list-name">Dịch vụ S-wifi
