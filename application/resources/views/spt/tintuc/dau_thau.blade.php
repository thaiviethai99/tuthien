    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
          ...
          <div class="list-items-wrap">
             <h1 style="margin-left: 20px;color: #113067;font-size:28px;padding-top: 16px">Đấu thầu</h1>
             @foreach($news as $item)
          <div class="list-item-dem">
              <div class="row">
               <div class="col-md-2 col-xs-2">
                   <a href="{{url('/tin-tuc/dau-thau-chi-tiet/'.$item->id.'/'.vn_to_str($item->title))}}" class="thumbnail">
