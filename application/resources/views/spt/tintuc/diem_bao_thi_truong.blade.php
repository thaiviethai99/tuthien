    ...
    <div class="page-wrapper">
        ...
        <header class="page-heading clearfix">
            <div class="breadcrumbs pull-left">
                <ul class="breadcrumbs-list">
                    ...
                    <li class="current">Điểm báo thị trường</li>
                </ul>
            </div><!--//breadcrumbs-->
        </header>
        </div>
        <div class="page-content">
          ...
          <div class="list-items-wrap">
             <h1 style="margin-left: 20px;color: #113067;font-size:28px;padding-top: 16px">Điểm báo thị trường</h1>
             @foreach($news as $item)
          <div class="list-item-dem">
              <div class="row">
                <div class="col-md-2 col-xs-3">  
                  <a href="{{url('/tin-tuc/diem-bao-thi-truong-chi-tiet/'.$item->id.'/'.vn_to_str($item->title))}}" class="thumbnail">
